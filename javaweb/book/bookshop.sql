...
CREATE TABLE `book` (
  ...
  `category_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '书籍分类代码',
...
) ENGINE=InnoDB AUTO_INCREMENT=1036 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `book` VALUES (1002, 'novel', '假面之夜+假面饭店+假面前夜', '25286485', '东野圭吾', '南海出版公司', '2018-06-01', '25286485-1_l_2.jpg', '新系列新CP。富丽堂皇的五星级大酒店，各怀心事的客人。平静的表面下暗流汹涌。杀人凶手即将在此现身。新田尚美联手揭开假面。', 115.90, 100, '2020-06-01 20:12:00');
...
-- ----------------------------
BEGIN;
INSERT INTO `order_item` VALUES (4, 6, 1001, 45.00, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `orders` VALUES (6, 2020001, '123', '123', '432345', '17607241644', b'0', '2021-06-13 09:05:26');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `shopping_cart` VALUES (8, 2020001, 1000, 37.80, 1);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2020002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of user_info
-- ----------------------------
BEGIN;
INSERT INTO `user_info` VALUES (2020001, 'fangmachuan', 'fmc123456', '2840334251@gmail.com', '', '2021-06-13 08:29:34');
COMMIT;
